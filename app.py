...
def _build_review_prompt(d, winner_line, is_tie, winners, best_score):
    ...
    return (
        ...
        "5) Добавь уместное экспертное мнение: как было бы правильнее действовать в реальной жизни.\n"
        "6) Если данных недостаточно для честной оценки (например, это голосование с ФИО без контекста события), "
        "не выдумывай факты и не делай категоричных выводов. Прямо напиши, что объективная оценка ограничена "
        "из-за нехватки информации, и перечисли, каких данных не хватает.\n"
